...
[`examples/kanidm.yaml`](https://github.com/pando85/kaniop/blob/v0.15/examples/kanidm.yaml):
...
[`examples/kanidm-custom-css.yaml`](https://github.com/pando85/kaniop/blob/v0.15/examples/kanidm-custom-css.yaml).
