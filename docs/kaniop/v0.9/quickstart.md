...
- [`examples/kanidm-ingress.yaml`](https://github.com/pando85/kaniop/blob/v0.9/examples/kanidm-ingress.yaml) -
  Kanidm with Ingress configuration
- [`examples/kanidm-replication.yaml`](https://github.com/pando85/kaniop/blob/v0.9/examples/kanidm-replication.yaml) -
